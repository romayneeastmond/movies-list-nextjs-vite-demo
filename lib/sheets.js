...
// Watchlist column order (A→M)
const WL_COLS = [
  "imdbID", "Title", "Year", "Poster", "Genre", "Runtime",
  "Director", "imdbRating", "Plot", "Watched", "DateAdded", "Source", "AddedBy",
];
...
export async function updateMovie(imdbID, changes) {
  ...
  await sheets.spreadsheets.values.update({
    spreadsheetId: sheetId(),
    range: `${WATCHLIST_SHEET}!A${sheetRow}:M${sheetRow}`,
    valueInputOption: "RAW",
